# This script opens a csv file as a dataframe, and tidies the column names
...
def FirstCharacterAString(x):
    if x[0] in ['1','2','3','4','5','6','7','8','9','0']:
        ...
        return x
# Reading the list of dataframe's column names
col_names=df.columns

# Applying previously defined functions to the column names and generating a list of updated names
...
# Updating dataframe's column names with the list of updated names and saving the dataframe as a new csv file
df.columns=col_names_updated
